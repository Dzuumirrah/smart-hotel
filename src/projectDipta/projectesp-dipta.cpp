...
// Hanya definisi fungsi, bukan setup()/loop() langsung
void setup_dipta_esp() {
    Serial.begin(115200);
    Wire.begin(21,17,100000); // SDA, SCL ESP32
    lcd.init();
    lcd.backlight();
...
void loop_dipta_esp() {
    ...
    lcd.setCursor(0,0);
    lcd.print("Penuh: "); lcd.print(slotPenuh); lcd.print("   ");
    lcd.setCursor(0,1);
    lcd.print("Kosong: "); lcd.print(slotKosong); lcd.print("   ");
